<template>
  <div>
    ...
    <nav-bread><span>order confirm</span></nav-bread>
      ...
      <div class="checkout-order">
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            <a class="btn btn--m btn--red"  @click="toSuccess">Proceed to payment</a>
          </div>
        </div>
      </div>
    </div>
        ...
        computed:{
            ...
            subtotal(){
                ...
                this.orderList.forEach((value)=>{
                   num += value.productNum*value.salePrice
                })
                return num
            },
            orderTotal(){
                return this.shipping - this.discount + this.tax +this.subtotal
            }
        },
        components:{
            NavHeader,
            ...
            toSuccess(){
              ...
              axios.post('/users/payment',{
                ...
                if(res.data.status=='0'){
                  ...
                  this.$router.push({
                    path:'/ordersuccess?orderId=' + orderId + '&orderTotal='+this.orderTotal
                    }) 
                }
              })
